...
class UserProfileActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        ...
        val saveButton: SKButton = findViewById(R.id.btn_save)
        if (v != null) {
            when(v.id) {
                image.id -> {
    ...
    private fun updateUserProfileDetails() {
        ...
        val rb: SKRadioButton = findViewById(R.id.rb_male)
    ...
    private fun validateUserProfileDetails(): Boolean {
        val mobile: SKEditText = findViewById(R.id.et_mobile_number)
        return when {
